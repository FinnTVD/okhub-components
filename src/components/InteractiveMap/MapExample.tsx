...
import InteractiveMap, {CityData, MapConfig, MapStyle} from './InteractiveMap'
...
// Example GeoJSON data (you need to provide your own)
const exampleGeoJsonData: GeoJsonObject = {
    ...
    <div className="w-full h-screen relative">
      ...
      <div className="w-full h-full relative">
        <InteractiveMap
          config={mapConfig}
          style={customStyle}
          geoJsonData={exampleGeoJsonData}
